...
/*   Updated: 2024/08/06 14:20:39 by msennane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	destroy_assets(t_game_state *state)
{
...
void	cleanup_game_resources(t_game_state *state)
{
	...
	if (state->mlx_instance && state->window_instance)
