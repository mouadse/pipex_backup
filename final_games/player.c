...
/*   Updated: 2024/08/06 11:29:52 by msennane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_player_images(t_game_state *state)
{
	...
	state->player.spirites[0] = mlx_xpm_file_to_image(state->mlx_instance,
			"./assets/xpm/wa-p0.xpm", &width, &height);
	state->player.spirites[1] = mlx_xpm_file_to_image(state->mlx_instance,
			"./assets/xpm/wa-p1.xpm", &width, &height);
	state->player.spirites[2] = mlx_xpm_file_to_image(state->mlx_instance,
			"./assets/xpm/wa-p2.xpm", &width, &height);
	state->player.spirites[3] = mlx_xpm_file_to_image(state->mlx_instance,
			"./assets/xpm/wa-p3.xpm", &width, &height);
}
